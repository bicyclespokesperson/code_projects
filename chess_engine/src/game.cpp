...
void Game::initialize()
{
  ...
  Board::get_board().square_at(0, 0).set_occupier(
      *(new Rook(*_player1, Color::white, (Board::get_board().square_at(0, 0)))));
  Board::get_board().square_at(1, 0).set_occupier(
      *(new Knight(*_player1, Color::white, (Board::get_board().square_at(1, 0)))));
  Board::get_board().square_at(2, 0).set_occupier(
      *(new Bishop(*_player1, Color::white, (Board::get_board().square_at(2, 0)))));
  Board::get_board().square_at(3, 0).set_occupier(
      *(new Queen(*_player1, Color::white, (Board::get_board().square_at(3, 0)))));
  Board::get_board().square_at(4, 0).set_occupier(*white_king);
  Board::get_board().square_at(5, 0).set_occupier(
      *(new Bishop(*_player1, Color::white, (Board::get_board().square_at(5, 0)))));
  Board::get_board().square_at(6, 0).set_occupier(
      *(new Knight(*_player1, Color::white, (Board::get_board().square_at(6, 0)))));
  Board::get_board().square_at(7, 0).set_occupier(
      *(new Rook(*_player1, Color::white, (Board::get_board().square_at(7, 0)))));
  Board::get_board().square_at(0, 1).set_occupier(
      *(new Pawn(*_player1, Color::white, (Board::get_board().square_at(0, 1)))));
  Board::get_board().square_at(1, 1).set_occupier(
      *(new Pawn(*_player1, Color::white, (Board::get_board().square_at(1, 1)))));
  Board::get_board().square_at(2, 1).set_occupier(
      *(new Pawn(*_player1, Color::white, (Board::get_board().square_at(2, 1)))));
  Board::get_board().square_at(3, 1).set_occupier(
      *(new Pawn(*_player1, Color::white, (Board::get_board().square_at(3, 1)))));
  Board::get_board().square_at(4, 1).set_occupier(
      *(new Pawn(*_player1, Color::white, (Board::get_board().square_at(4, 1)))));
  Board::get_board().square_at(5, 1).set_occupier(
      *(new Pawn(*_player1, Color::white, (Board::get_board().square_at(5, 1)))));
  Board::get_board().square_at(6, 1).set_occupier(
      *(new Pawn(*_player1, Color::white, (Board::get_board().square_at(6, 1)))));
  Board::get_board().square_at(7, 1).set_occupier(
      *(new Pawn(*_player1, Color::white, (Board::get_board().square_at(7, 1)))));

  // Round two!
  Board::get_board().square_at(0, 7).set_occupier(
      *(new Rook(*_player2, Color::black, (Board::get_board().square_at(0, 7)))));
  Board::get_board().square_at(1, 7).set_occupier(
      *(new Knight(*_player2, Color::black, (Board::get_board().square_at(1, 7)))));
  Board::get_board().square_at(2, 7).set_occupier(
      *(new Bishop(*_player2, Color::black, (Board::get_board().square_at(2, 7)))));
  Board::get_board().square_at(3, 7).set_occupier(
      *(new Queen(*_player2, Color::black, (Board::get_board().square_at(3, 7)))));
  Board::get_board().square_at(4, 7).set_occupier(*black_king);
  Board::get_board().square_at(5, 7).set_occupier(
      *(new Bishop(*_player2, Color::black, (Board::get_board().square_at(5, 7)))));
  Board::get_board().square_at(6, 7).set_occupier(
      *(new Knight(*_player2, Color::black, (Board::get_board().square_at(6, 7)))));
  Board::get_board().square_at(7, 7).set_occupier(
      *(new Rook(*_player2, Color::black, (Board::get_board().square_at(7, 7)))));
  Board::get_board().square_at(0, 6).set_occupier(
      *(new Pawn(*_player2, Color::black, (Board::get_board().square_at(0, 6)))));
  Board::get_board().square_at(1, 6).set_occupier(
      *(new Pawn(*_player2, Color::black, (Board::get_board().square_at(1, 6)))));
  Board::get_board().square_at(2, 6).set_occupier(
      *(new Pawn(*_player2, Color::black, (Board::get_board().square_at(2, 6)))));
  Board::get_board().square_at(3, 6).set_occupier(
      *(new Pawn(*_player2, Color::black, (Board::get_board().square_at(3, 6)))));
  Board::get_board().square_at(4, 6).set_occupier(
      *(new Pawn(*_player2, Color::black, (Board::get_board().square_at(4, 6)))));
  Board::get_board().square_at(5, 6).set_occupier(
      *(new Pawn(*_player2, Color::black, (Board::get_board().square_at(5, 6)))));
  Board::get_board().square_at(6, 6).set_occupier(
      *(new Pawn(*_player2, Color::black, (Board::get_board().square_at(6, 6)))));
  Board::get_board().square_at(7, 6).set_occupier(
      *(new Pawn(*_player2, Color::black, (Board::get_board().square_at(7, 6)))));
